...
# --- Hub Resource Group ---
module "rg_hub" {
  source   = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/resource_group?ref=v0.7.4"
...
module "hub_vnet" {
  source = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/hub_vnet?ref=v0.7.4"
...
module "bastion" {
  source = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/azure_bastion?ref=v0.7.4"
...
module "firewall" {
  source = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/azure_firewall?ref=v0.7.4"
...
module "spokes" {
  source   = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/spoke_vnet?ref=v0.7.4"
...
module "vms" {
  source   = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/linux_vm?ref=v0.7.4"
...
module "nsg_app" {
  source   = "git::https://github.com/pedrozea/azure-terraform-modules.git//modules/network_security_group?ref=v0.7.4"
  for_each = local.environments
